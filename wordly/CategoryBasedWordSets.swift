...
struct CategoryWordSets {
    ...
    static let scienceWords: [Word] = [
        ...
        Word(
            ...
            example: "The quantum theory revolutionized our understanding of atomic and subatomic processes."
        ),
        Word(
            term: "entropy",
            pronunciation: "/ˈɛntrəpi/",
            partOfSpeech: "noun",
            definition: "A thermodynamic quantity representing the unavailability of a system's thermal energy for conversion into mechanical work.",
            example: "The second law of thermodynamics states that entropy always increases in an isolated system."
        ),
        Word(
            term: "catalyst",
        ...
        Word(
            ...
            partOfSpeech: "noun",
            definition: "A proposed explanation for a phenomenon, made on the basis of limited evidence as a starting point for further investigation.",
            example: "The scientist developed a hypothesis to explain the unexpected experimental results."
        )
    ]
    ...
    static let businessWords: [Word] = [
        Word(
            ...
            example: "The company's acquisition of its rival created the largest firm in the industry."
        ),
        Word(
            term: "diversification",
            pronunciation: "/daɪˌvɜrsɪfɪˈkeɪʃən/",
            partOfSpeech: "noun",
            definition: "The process of a business enlarging or varying its range of products or field of operation.",
            example: "Diversification into new markets helped the company survive the economic downturn."
        ),
        Word(
            term: "leverage",
        ...
        Word(
            ...
            example: "The startup's business model demonstrated excellent scalability, allowing rapid expansion."
        ),
        Word(
            term: "synergy",
            ...
            example: "The merger created synergy between the two companies' complementary product lines."
        )
    ]
    ...
    static let artsWords: [Word] = [
        Word(
            ...
            example: "The juxtaposition of bright colors in the painting created a striking visual effect."
        ),
        Word(
            term: "renaissance",
        ...
        Word(
            ...
            example: "Rembrandt was a master of chiaroscuro, using it to create dramatic effects in his portraits."
        ),
        Word(
            term: "soliloquy",
            ...
            example: "Hamlet's 'To be or not to be' soliloquy is one of the most famous in Shakespeare's works."
        ),
        Word(
            term: "avant-garde",
            ...
            example: "The gallery specializes in avant-garde art that challenges conventional aesthetics."
        )
    ]
    ...
    static let technologyWords: [Word] = [
        ...
        Word(
            ...
            example: "End-to-end encryption ensures that only the intended recipient can read the message."
        ),
        Word(
            term: "virtualization",
            ...
            example: "Virtualization allows multiple operating systems to run on a single physical server."
        ),
        Word(
            term: "middleware",
            ...
            example: "The middleware layer enables different software applications to communicate with each other."
        )
    ]
        ...
        if selectedWords.isEmpty {
            selectedWords = [
                Word(
                    ...
                    example: "As a logophile, Julia loved to read new books to discover words she hadn't heard before."
                ),
                Word(
                    term: "ephemeral",
                    ...
                    example: "The ephemeral nature of fashion trends makes it hard to keep up with what's in style."
                ),
                Word(
                    term: "eloquent",
                ...
                Word(
                    ...
                    example: "Exercise is not a panacea for all health problems, but it helps with many."
                )
            ]
        }
