...
struct AccessibilityEnhancements {
    ...
    static func cardSwipeDescription(for word: Word) -> String {
        return
            "Card for word \(word.term). Swipe right to mark as known, swipe left to review later."
    }
    ...
    static func highContrastColor(standard: Color, highContrast: Color, isHighContrast: Bool)
        -> Color
    {
